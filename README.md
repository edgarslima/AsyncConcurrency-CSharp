...
```
2. **Open the solution** `AsyncConcurrency.sln` in Visual Studio 2019 or later.
3. **Build and run** the `AsyncConcurrency` project. It launches a WPF example demonstrating the different execution models.
